...
parser.add_argument('--train_path', default="datasets/pancreas_aabcd_abc_01/train.pkl", type=str,
					help='path to train data frame with labels')
parser.add_argument('--test_path', default="datasets/pancreas_aabcd_abc_01/test.pkl", type=str,
...
def main():
	...
	path = os.path.dirname(args.train_path) + "/JIND_Weighted"
	...
	temp = datetime.now()
	obj.weighted_remove_effect(train_mat, test_mat, train_config, test_labels)
