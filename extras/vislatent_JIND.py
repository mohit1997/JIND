...
parser = argparse.ArgumentParser(description='RUN JIND Latent Visualisation')
parser.add_argument('--train_path', default="datasets/pancreas_abcdnovel_01/train.pkl", type=str,
					help='path to train data frame with labels')
parser.add_argument('--test_path', default="datasets/pancreas_abcdnovel_01/test.pkl", type=str,
