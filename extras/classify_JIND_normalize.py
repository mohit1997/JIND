...
def main():
	...
	print("Data Loaded")
	train_mat = (train_mat-train_mat.mean())/(train_mat.std() + 1e-5)
	test_mat = (test_mat-test_mat.mean())/(test_mat.std() + 1e-5)
	print("Data Normalized")

	path = os.path.dirname(args.train_path) + "/JIND_normalize"
